 ...
 * runs in isolation from the root-package WireMockJwksTest.
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
@TestPropertySource(properties = "test.isolation=catalog-wm")
class WireMockJwksTest {
    ...
    static class JwtDecoderOverride {
        ...
        JwtDecoder wireMockJwtDecoder() {
            return NimbusJwtDecoder
                    .withJwkSetUri(wireMock.baseUrl() + "/oauth2/jwks")
                    .build();
        }
    }
    ...
    static void startWireMock() throws Exception {
        ...
        wireMock.stubFor(WireMock.get(urlEqualTo("/oauth2/jwks"))
    ...
    @Test
    void realJwt_fromWireMockJwks_returns200() throws Exception {
        String token = mintToken(Instant.now().plusSeconds(60));
    ...
    private String mintToken(Instant expiry) throws Exception {
